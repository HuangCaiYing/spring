...
@WebServlet(name = "EmpSavaServlet",urlPatterns = {"/empsave"})
public class EmpSavaServlet extends HttpServlet {
    ...
    Date hiredate= null;
        ...
        IEmpService empService= (IEmpService) SpringIOC.getSpringIOC().getBean("empSerivce");
